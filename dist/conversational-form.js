      ...
      if(typeof window !== 'undefined' && window.document && window.document.createElement) {
          ...
          if(typeof define === "function" && define.amd) {
              define(["conversational-form"], function(conversationalform){
                  return (window.conversationalform = factory(conversationalform));
              });
          } else if(typeof module === "object" && module.exports) {
              module.exports = (window.conversationalform = factory(require("conversational-form")));
          } else {
              window.conversationalform = factory(cf.ConversationalForm);
          }
      }
